"""删除比赛记录 API 路由 — 按 event_id + battle_id 删除一场比赛并撤回积分"""
...
@router.delete(
    ...
    summary="删除一场比赛并撤回积分",
    description="""根据赛事 ID + 对阵 ID 删除一场比赛,并撤回相关选手的积分。
...
async def delete_match_endpoint(
    ...
    """DELETE /api/v1/elo/records/{event_id}/{battle_id} — 删除一场比赛。"""
    resp = await delete_match(db, event_id, battle_id)
